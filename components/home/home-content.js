  ...
  return (
    <>
      ...
      <Container>
        <Row className={classes.intro_row}>
          <Col xs={12} lg={6} className={classes.intro_text_col}>
            ...
            <p className={classes.lead}>
              ...
              and reliable information, together with a range of useful services
              to ensure you enjoy a carefree and memorable stay.
            </p>
            <p>
              We would love to hear from you! No matter how large or small your
              question may be, we will do our best to assist at all times and to
              provide competent and reliable service. Please browse our website
              or just tap the bell to get in touch.
            </p>
            <Row className={classes.bell1}>
        ...
        <Row>
          <Col xs={12} md={6} lg={3} className={classes.reasons_col}>
          ...
          <Col xs={12} md={6} lg={3} className={classes.reasons_col}>
            <h4 className={classes.reason_heading}>WE PROTECT YOUR BOOKING</h4>
            <p className={classes.reason_text}>
              With years of work experience for some of the most reputable UK
              and EU operators, in roles that ranged from overseas holiday rep
              to senior commercial and product management, we fully understand
